...
public class Constant {
	...
	public static final String invalid_password="dummyPassword";
	
	
	//optional data - used in profilePageTest file
	
	//personal data
    public static final String profile_name = "Madhan Adithya";
    public static final String profile_location = "Coimbatore, Tamil Nadu";
    public static final String profile_college = "Coimbatore Institute of Technology";
    ...
    //keywords needed in SearchAndFilterTest file
